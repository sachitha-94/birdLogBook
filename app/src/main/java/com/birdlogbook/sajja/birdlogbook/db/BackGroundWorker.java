...
import com.birdlogbook.sajja.birdlogbook.view.LogInActivity;
...
BackGroundWorker extends AsyncTask<String,Void,String> {
    ...
    protected String doInBackground(String... params) {
       ...
       // String registerUrl="http://192.168.1.2/register.php";
        ...
        String shareLogNoteUrl="http://192.168.1.4/vaias/sendAccident.php";
                //"http://192.168.43.35 /pocketBird/shareLogNote.php";
